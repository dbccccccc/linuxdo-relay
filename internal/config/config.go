...
func Load() (*Config, error) {
	cfg := &Config{
		...
		LinuxDoAuthURL:         getEnv("APP_LINUXDO_AUTH_URL", "https://linux.do/oauth2/authorize"),
		LinuxDoTokenURL:        getEnv("APP_LINUXDO_TOKEN_URL", "https://linux.do/oauth2/token"),
		LinuxDoUserInfoURL:     getEnv("APP_LINUXDO_USERINFO_URL", "https://linux.do/api/user"),
